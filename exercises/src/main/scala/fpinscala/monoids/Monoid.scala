...
trait Foldable[F[_]] {
  ...
  def toList[A](as: F[A]): List[A] =
    foldMap(as)(List(_))(Monoid.listMonoid)
...
object StreamFoldable extends Foldable[Stream] {
  ...
  override def toList[A](fa: Stream[A]): List[A] =
...
object OptionFoldable extends Foldable[Option] {
  ...
  override def toList[A](fa: Option[A]): List[A] = {
    OptionFoldable.foldMap(fa)(List(_))(Monoid.listMonoid)
//    fa match {
//      case None => Nil
//      case Some(a) => List(a)
//    }
